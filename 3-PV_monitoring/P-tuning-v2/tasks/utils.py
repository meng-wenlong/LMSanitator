...
from tasks.custom.dataset import task_to_keys as custom_tasks

GLUE_DATASETS = list(glue_tasks.keys())
SUPERGLUE_DATASETS = list(superglue_tasks.keys())
CUSTOM_DATASETS = list(custom_tasks.keys())
NER_DATASETS = ["conll2003", "conll2004", "ontonotes"]
SRL_DATASETS = ["conll2005", "conll2012"]
QA_DATASETS = ["squad", "squad_v2"]


TASKS = ["glue", "superglue", "custom", "ner", "srl", "qa"]

DATASETS = GLUE_DATASETS + SUPERGLUE_DATASETS + CUSTOM_DATASETS + NER_DATASETS + SRL_DATASETS + QA_DATASETS
